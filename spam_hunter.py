...
class SpamHunter:
    ...
    def __init__(self, start_time, end_time, resfile):
        ...
        self.twitterfile = 'data/tweet_2022-05-09T23Z.json'
            ...
            for url, info in self.media_info.items():
                ...
                if (os.path.exists(imgpath)):
                    ...
                    if (sms_boxes and tweet_label > 0.5):
                        ...
                        info = {'image_name': imgname, 'image_path': imgpath, 'month': month, 'sms_label': True, 'sms_text': sms_text, 'tweet_label': True}
                    else:
                        info = {'image_name': imgname, 'image_path': imgpath, 'month': month, 'sms_label': False, 'tweet_label': False}
